   ...
   <!-- menu tengah -->
	<div id="menu-tengah">
    	...
    	<div id="content_menu">
        <div id="menu_header">
        	<form action="?page=search_peminjaman" method="post">
        	<table width="100%" height="100%" style="border:1px solid #9cc;">
            	<tr>
                	<td width="50%"><a href="?page=input_peminjaman">Input Peminjaman</a></td>
   	    ...
   	    <div class="zebra-table">
			...
			?>
   	        <tbody>
                ...
                <td align="center"><a href="?page=proses_kembali_peminjaman&id=<?php echo $data['id']; ?>&judul=<?php echo $data['judul']; ?>">kembali</a></td>
                <td align="center"><a href="?page=proses_perpanjang_peminjaman&id=<?php echo $data['id']; ?>&judul=<?php echo $data['judul'];?>&tgl_kembali=<?php echo $data['tgl_kembali']; ?>&lambat=<?php echo $lambat; ?>">perpanjang</a></td>
              </tr>              
            <?php $no++; } ?>
          ...
          <div id="menu_bottom">
        	<table width="100%" style="border:0px solid #9cc;">
            	<tr>
                	<td width="50%">Jumlah : <?php echo $total; ?> Peminjaman</td>
