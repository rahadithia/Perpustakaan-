				 ...
				 switch($_GET['page'])
				 	{
						...
						// menu buku				
						case "buku";
						include "../admin/buku_data.php";
						break;
						case "detil-buku";
						include "../admin/buku_detil.php";
						break;
						case "buku_input";
						include "../admin/buku_input.php";
						break;
						case "buku_proses";
						include "../admin/buku_proses.php";
						break;
						case "buku_search";
						include "../admin/buku_search.php";
						break;
						case "buku_edit";
						include "../admin/buku_edit.php";
						break;
						case "buku_proses_edit";
						include "../admin/buku_proses_edit.php";
						break;
						case "buku_hapus";
						include "../admin/buku_hapus.php";
						break;
